...
export default function EducationSection() {
  ...
  return (
    <section
      id="education"
      className="relative z-20 scroll-mt-20 flex flex-col px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32 rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] -mt-10 sm:-mt-12 md:-mt-14"
      ...
      <div className="flex flex-col w-full items-center">
        {education.map((item, i) => {
          ...
          return (
            ...
            >
              {i > 0 && (
                <div className="w-full" style={{ borderTop: "1px solid rgba(215, 226, 234, 0.15)" }} />
              )}
