...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="min-h-screen scroll-mt-20 flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 relative"
    >
      ...
      <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24 max-w-6xl w-full relative z-10">
        <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 w-full">
          ...
          <AnimatedText
            text={profile.bio}
            className="text-[#D7E2EA] font-medium text-center leading-relaxed max-w-[1000px]"
            style={{
